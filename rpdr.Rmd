...
5. survey_votes: vote-level data from the [survey](https://www.allourideas.org/rpdr-s11-w10) (you can participate!), current season (season 11)
6. survey_contestants: contestant-level data from the [survey](https://www.allourideas.org/rpdr-s11-w10), current season (season 11)
