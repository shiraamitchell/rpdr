...
5. survey_votes: vote-level data from the [survey](https://www.allourideas.org/drag-race-s11) (you can participate!), current season (season 11)
6. survey_contestants: contestant-level data from the [survey](https://www.allourideas.org/drag-race-s11), current season (season 11)
...
all_episodes_next <- add_row(all_episodes, season_number = 11, episode_number = 1,
...
next_contestants <- (all_contestants %>% filter(season_number == 11))$contestant_id
all_rankings_next <- add_row(all_rankings, season_number = 11, episode_number = 1, 
